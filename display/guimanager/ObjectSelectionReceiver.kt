...
object ObjectSelectionReceiver : EventReceiver {

    private val selectedObject : LObservable<Int> = LObservable(0)
    ...
    init{
        selectedObject.addListener { FighterMenuDisplayer.selectingActions(selectedObject.value) }
    }
    ...
    override fun escape() {
        ...
        TODO("Display fighter menu needs a FighterData")
